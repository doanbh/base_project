...
class AppColors {
  static const Color app_main = Color(0xFFf17d59);
  ...
  static const Color nero = Color(0xFF282828);
  ...
  static const primary = Color(0xFFf17d59);
  static const secondaryColor = Color(0xFF555555);
  static const thirdColor = Color(0xFF364c54);
  ...
  //home
  static const Color item_green = Color(0xFF00a65a);
  static const Color item_blue = Color(0xFF00c0ef);
  static const Color item_yellow = Color(0xFFf39c12);
  static const Color item_red = Color(0xFFdd4b39);

  static const grey8B8B8B = Color(0xff8B8B8B);
